package com.plume.aspect;

import com.plume.annotation.AutoFill;
import com.plume.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.plume.mapper.*.*(..))&&" +
            "@annotation(com.plume.annotation.AutoFill)")
    ...
    public void autoFillBefore(JoinPoint joinPoint){
        log.info("AutoFillAspect.autoFillBefore()");
